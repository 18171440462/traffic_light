...
if __name__ == "__main__":
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '/home/ie/桌面/ZDW/projects/traffic_light/dataset/train.txt'
    val_annotation_path     = '/home/ie/桌面/ZDW/projects/traffic_light/dataset/test.txt'
